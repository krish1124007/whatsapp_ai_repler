...
router.get('/top-queries', async (req, res) => {
    try {
        ...
        const KEYWORDS = [
            { label: 'Package enquiry',         terms: ['package', 'packages', 'offer', 'deal'] },
            { label: 'Price / budget query',    terms: ['price', 'cost', 'budget', 'how much', 'rate'] },
            { label: 'Travel dates',            terms: ['date', 'dates', 'when', 'month', 'schedule'] },
            { label: 'Flight / transport',      terms: ['flight', 'train', 'bus', 'car', 'cab'] },
            { label: 'Hotel / stay',            terms: ['hotel', 'stay', 'resort', 'room', 'accommodation'] },
            { label: 'Status / callback',       terms: ['status', 'callback', 'call', 'update'] },
            { label: 'Domestic travel',         terms: ['goa', 'manali', 'kerala', 'shimla', 'kashmir'] },
            { label: 'International travel',     terms: ['dubai', 'thailand', 'europe', 'maldives', 'singapore'] },
            { label: 'Honeymoon',               terms: ['honeymoon', 'couple', 'romantic'] },
        ];
...
router.get('/ai-summary/:phone', async (req, res) => {
    try {
        ...
        const TRAVEL_TOPICS = ['goa', 'manali', 'kerala', 'dubai', 'thailand', 'europe', 'maldives', 'honeymoon', 'flight', 'hotel', 'package'];
        TRAVEL_TOPICS.forEach(lt => {
